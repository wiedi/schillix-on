...
#define HAVE___FILBUF 1		/* if we have __filbuf() for USG derived STDIO */
...
#define DEV_MINOR_BITS 18		/* # if bits needed to hold minor device number */
 ...
 */
#define HOST_ALIAS "i386-pc-solaris2.11"		/* Output from config.guess (orig)	*/
#define HOST_SUB "i386-pc-solaris2.11"			/* Output from config.sub (modified)	*/
